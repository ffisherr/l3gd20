...
#define L3GD20_CS_ENABLE()					HAL_GPIO_WritePin(HYRO_CSn_GPIO_Port, HYRO_CSn_Pin, 0)
#define L3GD20_CS_DISABLE()					HAL_GPIO_WritePin(HYRO_CSn_GPIO_Port, HYRO_CSn_Pin, 1)
	
#define ENABLE_LED(LED_PORT, LED_PIN)		HAL_GPIO_WritePin(LED_PORT, LED_PIN, 1) 
#define DISABLE_LED(LED_PORT, LED_PIN)		HAL_GPIO_WritePin(LED_PORT, LED_PIN, 0) 
